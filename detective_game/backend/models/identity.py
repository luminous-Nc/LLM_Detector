...
class Role:
    ...
    def from_type(cls, role_type: RoleType) -> "Role":
        ...
        return cls(
            ...
            kill_cooldown=config.get("kill_cooldown", 0),
...
class PlayerIdentity:
    ...
    def can_use_kill(self) -> bool:
        ...
        return (
            ...
            and self.kill_cooldown_remaining == 0
    ...
    def use_kill(self) -> None:
        ...
        self.kill_cooldown_remaining = self.role.kill_cooldown
    
    def tick_cooldown(self) -> None:
        """回合结束时减少冷却"""
        if self.kill_cooldown_remaining > 0:
            self.kill_cooldown_remaining -= 1
    ...
    def to_dict(self, reveal_role: bool = False) -> Dict[str, Any]:
        ...
        if reveal_role:
            ...
            result["kill_cooldown_remaining"] = self.kill_cooldown_remaining
        return result
